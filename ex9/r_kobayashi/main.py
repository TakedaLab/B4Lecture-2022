...
def main():
    ...
    parser.add_argument("--path_to_truth", "-p", type=str, help="テストデータの正解ファイルCSVのパス")
    parser.add_argument("--epoch", "-e", type=int, default=100, help="エポックの数")
    parser.add_argument("--batch", "-b", type=int, default=32, help="ミニバッチの数")
    ...
    plt_history(history, args.epoch)
    # モデル構成，学習した重みの保存
    ...
    if args.path_to_truth:
        test_truth = pd.read_csv(os.path.join("../", args.path_to_truth))
